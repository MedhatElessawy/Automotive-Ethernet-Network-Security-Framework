            ...
            while True:
                ...
                if p_type == TYPE_ROUTING_ACTIVATION_REQ:
                    ...
                    response_payload = (
                            ...
                            struct.pack('!H', LOGICAL_ADDR) +  # ECU logical address (bytes 2-3)
                    ...
                    if uds_res is not None:  # Only send if there's a response
                        ...
                        # CHANGE HERE: Use TYPE_DIAGNOSTIC_MESSAGE (0x8001) instead of TYPE_DIAGNOSTIC_POS_ACK
    ...
    def start(self):
        ...
        while self.running:
            try:
                ...
                try:
                    # Perform TLS handshake - this is the key step!
                ...
                # Pass the SECURE socket to handler
                threading.Thread(
